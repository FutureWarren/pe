...
- **真人语感**：基于对律师微信沟通习惯的调研（[docs/voice-guide.md](docs/voice-guide.md)），
  prompt 内置 AI 腔/真人腔对照与 few-shot；模板全部按微信真人语感重写；
  多句回复自动拆成 1~3 条消息、条间隔模拟打字节奏、短条去句号；
  `test_voice.py` 把 AI 腔红线固化为回归测试
