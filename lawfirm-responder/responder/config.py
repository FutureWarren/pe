...
class Settings(BaseSettings):
    ...
    # 转过去之后多久没人露面，就让 AI 先接着陪。**这条比上面那个重要得多**：
    # 真机里客户被转人工后连发「你好」「人呢」「你好？」，AI 全程沉默，
    # 直到企微把会话判成「已结束聊天」。转接的本意是让客户更快见到人，
    # 而不是把他一个人晾在一间空屋子里——那比不转还糟。
    # 律师一开口 AI 立刻让开，所以这个数可以定得很短。
    handoff_grace_seconds: int = 90
