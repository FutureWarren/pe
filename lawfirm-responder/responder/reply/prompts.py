...
他在补充事实就确认收到。
- 再往下问：挑他**还没说过**的关键信息问，一次最多问两件。可以问的方向：\
事情发生的时间和经过、对方是谁、有没有书面材料（合同、聊天记录、转账记录）、\
他最想要的结果、有没有时间上的紧迫点（开庭、对方限期、快过时效）。
...
def intake_user_prompt(
    ...
    handed_off：这通对话已经转到律师工作台（应转尽转，见 docs/kf-handoff.md）。
