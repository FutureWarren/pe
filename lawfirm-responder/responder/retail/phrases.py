...
DEFAULTS: dict[str, str] = {
    ...
    "compare": "这两款主要差在影像和屏幕上，日常用差别不大，"
               ...
               "我按您的用法给您说得具体点。",
    # 关注公众号那一刻发的第一句。**这一条不能空**：接管服务器配置之后，
    # 公众号后台的「自动回复」整个失效，这里不回等于新关注的人一句话都收不到。
    "subscribe": "您好，这里是酷机时代。手机、配件、维修保修、以旧换新，"
                 "有事直接在这儿说就行，看到就回。",
    # 开场白。它同时干两件事：让客户知道有人在，**并告诉他能问什么**——
    # 后者更值钱：一句「您好请问有什么可以帮您」换来的往往是沉默，
    # 而列出几个具体选项，客户会照着挑一个说。
    "chitchat": "在的您说。手机、配件、维修保修、以旧换新，这些我都能查，"
                "您直接说就行。",
